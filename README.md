# 프로젝트 02. 리텐션 분석: 이커머스의 마케팅 전략 수립을 위한 EDA

### 주제:  이커머스**의 마케팅 전략 수립을 위한 EDA**

- **본 프로젝트 중 본인은 리텐션분석, 세분화된 고객 등급별 구매 행동 분석을 맡았습니다.**
...
[프로젝트 보고서 전체 보기 (노션)](https://www.notion.so/01-EDA-1c9339280c3780f28fc1d128e9df0466?pvs=4)
